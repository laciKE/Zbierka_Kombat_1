...
\ries{Laco} Ak $n<0$, potom aj $k<0$ a všetky kombinačné čísla sú nulové, takže aj výsledná suma je nulová. Ak $n=$, tak jedine pre $k=0$ obsahuje suma nenulový člen a je rovná $1$. Ak $n>0$, môžeme použiť binomickú vetu:
$$
